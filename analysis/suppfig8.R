...
# write.csv(summary_data, here::here("Data", "truncated_data.csv"), row.names = F)
# summary_data = read.csv(here::here("Data", "truncated_data.csv"))
...
ggsave(here::here("Figures", "suppfig8.png"), width = 11, height = 8)
